...
public class Act_Products extends AppCompatActivity {
    ImageView Img_Back, Img_Search, Img_Share, Img_More,Img_Sale;
    ...
    View.OnClickListener rowClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (Edt_ProPrice.getText().toString().trim().length() == 0 && Edt_ProName.getText().toString().trim().length() == 0) {
                Text_Id.setText("Product Id");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (Img_More.getVisibility()==View.GONE){
...
//        PrintData(SearchP, null);
    ...
    void PrintData(String Search, String Order) {
        try {
            ...
            _ClassDatabase.CreateTable(Ctx);
            ArrayList<ContentValues> _ArrayList = _ClassDatabase.SelectData(Ctx, Search, 1, Order);
            for (ContentValues _ContentValues : _ArrayList) {
                View _v = View.inflate(this, R.layout.row_product, null);
                TextView Text_Price = (TextView) _v.findViewById(R.id.Text_Price);
                TextView Text_NameUser = (TextView) _v.findViewById(R.id.Text_NameUser);
