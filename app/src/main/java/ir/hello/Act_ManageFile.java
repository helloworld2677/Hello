...
public class Act_ManageFile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (_v.getTag().equals("Create_Folder")){
                if (_File.exists())
                    _Globalclass.DisPlayToast(Act_ManageFile.this,"File Exists");
                else
                    _File.mkdir();
                _Globalclass.DisPlayToast(Act_ManageFile.this,"Create Folder");
            }else if (_v.getTag().equals("Delete_Folder")){
                if (!_File.exists())
                    _Globalclass.DisPlayToast(Act_ManageFile.this,"No Folder");
                else
                    _File.delete();
                _Globalclass.DisPlayToast(Act_ManageFile.this,"Delete Folder");
            ...
            _Globalclass.DisPlayToast(Act_ManageFile.this,Error.getMessage());
        }
    }
